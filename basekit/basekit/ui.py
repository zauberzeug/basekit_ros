...
class NiceGuiNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.subscription = self.create_subscription(PoseStamped, 'pose', self.handle_pose, 1)
    ...
    def handle_pose(self, msg: PoseStamped) -> None:
        self.position.text = f'x: {msg.pose.position.x:.2f}, y: {msg.pose.position.y:.2f}'
        self.robot_3d.move(msg.pose.position.x, msg.pose.position.y)
        self.robot_3d.rotate(0, 0, 2 * math.atan2(msg.pose.orientation.z, msg.pose.orientation.w))
